...
date = '02.11.2013'
day, month, year = date.split('.') # Получаем дату от пользователя и сразу разбиваем по разделителю.
day = int(day) # Приводим все к типу int
month = int(month)
year = int(year)

print(days[day], months[month], year, 'года.') # Теперь используем значения пользователя в роли индекса
