...
#ЧТО Я ЗАМЕТИЛ:
# при выборе пункта меню не проваливается глубже. так и не выяснил остаток на счету. Потому что эта процедура не
# описана в коде. Есть предположение, что придется через регулярные выражения проверять правильность номера карты и
# пинкода, только какие в этом случае могут быть неверные данные? использование букв в любом случае даст отказ
# и не выполнит код...
...
def withdraw_money(person, money): #withdraw - снимать
